...
//			add_submenu_page( 'throws-spam-away', __( 'おすすめ設定', self::DOMAIN ), __( 'おすすめ設定', 'throws-spam_away' ), $mincap, 'throws-spam-away/throws_spam_away.class.php', array( $this, 'recommend_setting' ) );
		}
